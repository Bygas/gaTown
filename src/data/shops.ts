...
export const SHOPS: ShopDef[] = [
  {
    id: 'wanwupu',
    name: 'Genel Dükkân',
    description: 'Hasan Enişte`nin işlettiği dükkân; tohum ve günlük ihtiyaçlar satar.',
  ...
  },
  {
    id: 'tiejiangpu',
    name: 'Demirci',
    description: 'Demirci Ali`nin dükkânı; cevher ve metal ürünler satar.',
    npcName: 'Demirci Ali',
    closedDays: ['sun'],
    openHour: 7,
    closeHour: 18,
  ...
  },
  {
    ...
    description: 'Baran`ın işlettiği dükkân; silahlar ve savaş malzemeleri satar.',
    npcName: 'Baran',
    closedDays: [],
    openHour: 10,
    closeHour: 22,
  ...
  },
  {
    id: 'chouduanzhuang',
    name: 'İpek Mağazası',
    description: 'Suna`nın işlettiği mağaza; kumaş ve zarif hediyeler satar.',
    npcName: 'Suna',
    closedDays: ['sat', 'sun'],
    openHour: 9,
    closeHour: 18,
